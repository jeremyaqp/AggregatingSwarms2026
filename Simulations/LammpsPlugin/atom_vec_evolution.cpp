...
AtomVecEvolution::AtomVecEvolution(LAMMPS *lmp) : AtomVec(lmp)
{
  ...
  fields_grow = {"q", "mu", "phi", "q_reward"};
  fields_copy = {"q", "mu", "phi", "q_reward"};
  fields_comm = {"mu3"};
  fields_comm_vel = {"mu3"};
  fields_border = {"q", "mu", "phi", "q_reward"};
  fields_border_vel = {"q", "mu", "phi", "q_reward"};
  fields_exchange = {"q", "mu", "phi", "q_reward"};
  fields_restart = {"q", "mu", "phi", "q_reward"};
  fields_create = {"q", "mu", "phi", "q_reward"};
