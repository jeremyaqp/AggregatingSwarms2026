...
if __name__ == "__main__":
    ...
    for i, f in enumerate(files):
        ...
        print("Showing trajectory for particle 20")
        part = df[df["particle"] == 20]
        ...
        plt.xlabel(r"x (cm)")
        plt.ylabel(r"y (cm)")
        plt.savefig("../out/Robot_trajectory.png", dpi=300)
        print("Trajectory saved to ../out/Robot_trajectory.png")
        plt.show()
        plt.clf()
        exit()